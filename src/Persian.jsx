  ...
  return (
    <html>
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/font_awesome/6.0.0_beta3/css/all.min.css"
        />
          ...
          <div class="menu_Section flex">
            ...
            <div class="menu_items">
              <div class="img Espresso">
                <img
                  src="./Styles/img/img/Espresso.jpg"
                  alt="اسپرسو"
                  class=""
                />
              </div>
            ...
            <div class="menu_items">
              ...
              <div class="item_text">
                ...
                <div class="item_Description">قهوه + شکلات + شیر + فوم شیر</div>
              </div>
            </div>
          ...
          <div class="menu_Section flex">
            ...
            <div class="menu_items">
              ...
              <div class="item_text">
                ...
                <div class="caution">
                  <i class="fa_solid fa_triangle_exclamation Caution_icon" />هشدار
                  آلرژی
                </div>
              </div>
            </div>
