        ...
        <div className="Menu_section">
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Espresso + Milk</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Coffee + Milk + Milk Foam</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">1 Coffee + 1 Milk</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">
                Coffee + Chocolate + Milk + Milk Foam
              </div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Kurdish Special Coffee</div>
            </div>
          </div>
        </div>
        ...
        <div className="Menu_section">
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Lotus Cream</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Peanut Butter</div>
              <div className="caution">
                <i className="fa_solid fa_triangle_exclamation Caution_icon" />Allergy
                Warning
              </div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Nutella Chocolate</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Milka Chocolate</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">
                Vanilla Ice Cream + Vanilla Syrup
              </div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Double Shot Espresso</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Saffron + Rosewater</div>
            </div>
          </div>
        </div>
        ...
        <div className="Menu_section">
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Frozen Strawberry</div>
              <div className="item_Descr">(Optional: Sugar or Honey)</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Watermelon</div>
              <div className="item_Descr">(Optional: Sugar or Honey)</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Lemon + Strawberry</div>
              <div className="item_Descr">(Optional: Sugar or Honey)</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Watermelon + Strawberry</div>
              <div className="item_Descr">(Optional: Sugar or Honey)</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Lemon + soda + Sprite + Mint</div>
            </div>
          </div>
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Lemonade + Soda + Sprite</div>
            </div>
          </div>
        ...
        <div className="Menu_section">
          ...
          <div className="menu_items">
            ...
            <div className="item_text">
              ...
              <div className="item_Descr">Echium</div>
            </div>
          </div>
